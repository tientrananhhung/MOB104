		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<f:form cssClass="login100-form validate-form" method="POST"
					modelAttribute="dangnhapNV" action="dangnhapNV">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="dangnhap"> Trang đăng nhập cho khách
							hàng<i class="fa fa-long-arrow-right m-l-5" aria-hidden="true"></i>
						</a>
					</div>
				</f:form>
			</div>
