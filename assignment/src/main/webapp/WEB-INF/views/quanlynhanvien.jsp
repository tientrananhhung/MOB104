							...
							<table id="myTable" class="table table-bordered table-striped">
								...
								<tbody>
									<c:forEach var="item" items="${dsNhanVien}">
										<tr>
											<td><img style="width: 40px; height: 50px;"
												src="resources/${item.anhDaiDien}" /></td>
											...
											<td><a
												href="quanlynhanvien/editnhanvien/${item.maNhanVien}"><i
													class="fa fa-pencil"></i></a> <a
												href="quanlynhanvien/xoanhanvien/${item.maNhanVien}"><i
													class="fa fa-bitbucket-square"></i></a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
