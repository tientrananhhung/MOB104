	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-5 col-md-4">
				...
				<c:otherwise>
				<div class='content text-center' style='padding: 10px;'> <h3 class='h4'>Bạn là khách hàng mới?</h3> <a href='dangky' class='btn btn-primary' style='padding: 10px;'> <span>Đăng ký ngay</span> </a> <h3 class='h4' style='padding: 10px; margin: 0px;'>Hoặc</h3> <a id='login' href='dangnhap'> <span>ĐĂNG NHẬP</span> </a> </div>
				</c:otherwise>
				</c:choose>
