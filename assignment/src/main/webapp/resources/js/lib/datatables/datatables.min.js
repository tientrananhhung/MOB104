...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Đầu",sLast:"Cuối",sNext:"Tiếp tục",sPrevious:"Trở lại"},sEmptyTable:"No data available in table",sInfo:"Hiển thị _START_ đến _END_ của _TOTAL_ bản ghi",sInfoEmpty:"Hiển thị từ 0 đến 0 của 0 bản ghi",sInfoFiltered:"(Đã lộc từ _MAX_ bản ghi)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ bản ghi",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
